 ...
 *                                  dns.h                                     *
 * This file contains the declaration of all the structs used in dns query.   *
...
/**
 * This struct records the question section of DNS message
 */
...
/**
 * This struct records the resourse record section of DNS message
 */
...
/**
 * This struct records the DNS message
 */
...
/**
 * This struct build a list of DNS message
 */
...
/**
 * This struct records info used in dns connections
 */
typedef struct dns_t_s
{
    ...
    //1 dns request formed; 3 resolve success;
